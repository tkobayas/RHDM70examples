    ...
    public static final void main(String[] args) {
        try {
...

            {
                ...
                //LocalDate date = LocalDate.from(formatter.parse("2018-10-01"));
                LocalDate date = LocalDate.from(formatter.parse("2019-06-05"));

                context.set("DATE_OF_SERVICE", date);
                ...
                System.out.println("RESULT = " + result.get("Final Decision"));
            }
